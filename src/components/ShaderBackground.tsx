...
const ShaderBackground = () => {
  ...
  const fsSource = `
    ...
    const float lineSpeed = 0.75 * overallSpeed;
    const float lineAmplitude = 0.6;
    ...
    void main() {
      ...
      for(int l = 0; l < linesPerGroup; l++) {
        ...
        float line = drawSmoothLine(linePosition, halfWidth, space.y) / 2.2 + drawCrispLine(linePosition, halfWidth * 0.12, space.y);
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      ...
      const scaleFactor = dpr > 1 ? 0.55 : 0.75;
    ...
    let startTime = 0;
    let lastFrameTime = 0;
    const fpsInterval = 1000 / 30; // 30 FPS cap to reduce GPU load
