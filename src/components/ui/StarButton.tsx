...
function StarBackground({ color }: StarBackgroundProps) {
    return (
        ...
        >
            <g clipPath="url(#clip0_408_119_button)">
                <path
...
export function StarButton({
    ...
    return (
        <button
            ...
            ref={pathRef}
            className={cn(
                "relative z-[3] overflow-hidden h-14 w-14 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 group/star-button active:scale-95",
                className,
            )}
            {...props}
        >
            <div
                className="absolute w-[200%] h-[200%] -left-[50%] -top-[50%] animate-star-btn bg-[radial-gradient(ellipse_at_center,var(--light-color),transparent,transparent)] opacity-40"
                style={
                    {
                        offsetPath: "var(--path)",
                        offsetDistance: "0%",
